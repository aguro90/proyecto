...
<form id="regForm" action="#">
  ...
  <div id="infoPanel">
   ...
   <button type="button" onclick="initialize(parseInt(document.getElementById('radio').value),parseFloat(document.getElementById('lat').innerHTML),parseFloat(document.getElementById('lng').innerHTML));">Pincha</button>
